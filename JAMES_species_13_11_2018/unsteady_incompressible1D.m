...
path_Results1 = 'C:\Users\s137280\Documents\Master_tue\Internship\internship_github\JAMES_species_13_11_2018\results\output.txt';
path_Results2 = 'C:\Users\s137280\Documents\Master_tue\Internship\internship_github\JAMES_species_13_11_2018\results\diff.txt';
path_Results3 = 'C:\Users\s137280\Documents\Master_tue\Internship\internship_github\JAMES_species_13_11_2018\results\x_dummy.txt';
...
[rho_s, Y_k, X_k, Y_in, X_in, Y2_k, X2_k, Y2_in, X2_in, iAll, MW, rho_real, rho2_real, D, D_k, D2_k, P_k, f_old, f2_old, sink, n] = species_init(NPI);
...
%     
    %% Species 
    for i = 1:n
        [aE_f(i,:), aW_f(i,:), aP_f(i,:), b_f(i,:), Istart_f, Y_sink(i,:)] = Fcoeff(NPI, rho, rho_s(i), A, x, x_u, u, Y_k(i,:), Y2_k(i,:),T, rho_real, rho2_real, P_k(i,:), D_k(i,:), relax_f, Dt, f_old(i,:), Dx, rho_old, sink(i), i);
    ...
    %% Permeate Species 
    for i = 1:n
        [aE_f(i,:), aW_f(i,:), aP_f(i,:), b_f(i,:), Istart_f, Y_source(i,:)] = F2coeff(NPI, rho, rho_s(i), A, x, x_u, u, Y_k(i,:), Y2_k(i,:),T, rho_real, rho2_real, P_k(i,:), D_k(i,:), relax_f, Dt, f2_old(i,:), Dx, rho_old, sink(i), Y_sink(i,:), i);
    ...
    [u_old, pc_old, rho_old, f_old, f2_old] = storeresults(NPI, u, pc, rho, Y_k, Y2_k, u_old, pc_old, rho_old, f_old, f2_old, n);
