function [u, p, pc, T, rho, mu, Cp, Gamma, d_u, A, b, SP, Su, relax_u, relax_pc, relax_T, relax_rho, Dt, u_old, T_old, pc_old, rho_old] = param_init(NPI, u_in);
    m_in    = 1;
    m_out   = 1;
    Dt = 0.01;
    for I=1:NPI+2
