function [rho_s, MW_mix, MW2_mix, Y_k, X_k, Y_in, X_in, Y2_k, X2_k, Y_in2, X_in2, iAll, MW, rho_real, rho2_real, rho_old, rho2_old, D, D_k, D2_k, P_k, f_old, f2_old, sink, n] = species_init(NPI)
...
moles = [16.667; 83.333];
% moles = [0.246604699002973; 0.753395300997027];   % leaves permeate m1
% moles = [ 0.602827807491870; 0.397172192508130];    % leaves permeate m2
...
P_n   = [350; 31.5]*10^(-9);  % Permeability of species
...
rho_s = [1.98 1.784];          % 'Real' density of species [kg/m^3]
